...
<html>
   <head>
    ...
    <body>
        ...
        <form style="position: absolute;width: 320px;height: 150px;left: 40%;top: 10%" action="cust_add.jsp" method="post" id="myform">
            <fieldset>
                <legend>添加</legend>
        ...
        <form style="position: absolute;width: 320px;height: 150px;left: 40%;top: 45%" action="" method="post" id="myform2">
            <fieldset>
            <legend>查询 删除</legend>
            <table align="center" valign="center">
                <tr>
