...
<html>
   <head>
    ...
    <body style="text-align:center; background-color: aqua">
        ...
        <form style="position: absolute;width: 300px;height: 150px;left: 40%;top: 10%" action="det_add.jsp" method="post" id="myform">
            <fieldset>
                <legend>添加</legend>
        ...
        <form style="position: absolute;width: 300px;height: 150px;left: 40%;top: 51%" action="det_sum.jsp" method="post" id="myform3">
            <fieldset>
                <legend>查询全部</legend>
            <table align="center" valign="center">
                <tr>
