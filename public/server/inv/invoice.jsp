   ...
   <head>
    ...
    <body>
        <button onmousemove="color='red'" style="position: absolute;left: 1%" onclick="window.location.href='../../HP.html'">返回主界面</button>
         <form style="position: absolute;width: 300px;height: 150px;left: 40%;top: 10%" action="inv_add.jsp" method="post" id="myform">
             <fieldset>
                 <legend>添加</legend>
        ...
        <form style="position: absolute;width: 300px;height: 150px;left: 40%;top: 40%" action="" method="post" id="myform2">
           <fieldset>
            <legend>查询 删除</legend>        
            <table align="center" valign="center">
                <tr>
        ...
        <form style="position: absolute;width: 300px;height: 150px;left: 40%;top: 56%" action="inv_mod.jsp" method="post" id="myform3">
           <fieldset>
           <legend>修改</legend>
            <table align="center" valign="center">
                <tr>
                ...
                <tr>
                    <td>购买日期：</td>
                    <td><input type="date" name="pay_d" size="1"></td>
                </tr>
                <tr>
                    <td>付款金额：</td>
